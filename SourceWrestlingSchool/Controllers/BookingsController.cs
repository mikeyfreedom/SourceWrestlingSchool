...
namespace SourceWrestlingSchool.Controllers
{
    public class BookingsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BookingID,BookingDate,UserID")] Booking booking)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BookingID,BookingDate,UserID")] Booking booking)
        {
            if (ModelState.IsValid)
            {
